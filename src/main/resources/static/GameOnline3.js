class GameOnline3 extends Phaser.Scene {

    constructor() {
        super({ key: "GameOnline3" }); // Nombre único de la escena
    
        // Jugadores
        this.jugadores = {
            gatoA: this.crearJugador(1, 510, 620, 'frenteA'),
            gatoB: this.crearJugador(2, 670, 620, 'frenteB')
        };
