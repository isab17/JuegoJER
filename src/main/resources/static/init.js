...
const config = {
    ...
    scene: [Iniciarsesion, MapaOnline,MapaSalaPrivada, MenuPrincipal, Chat, TutorialScene1, TutorialScene2, TutorialScene3, TutorialScene4, Creditos,Partidas, GameOnline1,Mapa, GameLocal1, GameLocal2, PauseMenu, ResultScreen], // Scene que contiene la lógica del juego
